...
(async function (Scratch) {
  ...
  if (!Scratch.extensions.unsandboxed)
    throw new Error("BackLayer 3D must run unsandboxed");
  ...
  function installBackLayer() {
    if (!renderer._layerGroups.backlayer3d) {
      ...
      renderer._layerGroups.backlayer3d = {
        groupIndex: 0,
        drawListOffset: videoGroup.drawListOffset,
      };
      renderer._groupOrdering.forEach(
        (n, index) => (renderer._layerGroups[n].groupIndex = index)
      );
    }
  ...
  const updateFog = () =>
    (scene.fog = fogEnabled
      ? new THREE.Fog(fogColor, 1, Math.max(1, fogDistance))
      : null);
  const box = (root) => new THREE.Box3().setFromObject(root);
  const touching = (a, b) =>
    a &&
    b &&
    !a.userData.passThrough &&
    !b.userData.passThrough &&
    box(a).intersectsBox(box(b));
  ...
  function updatePhysics(delta) {
    ...
    for (const moving of objects.values()) {
      ...
      moving.userData.velocityY =
        (moving.userData.velocityY || 0) + GRAVITY * delta;
      ...
      for (const other of objects.values()) {
        ...
        if (moving.userData.velocityY <= 0)
          moving.position.y += otherBox.max.y - movingBox.min.y;
  ...
  class BackLayer3D {
      ...
      return {
        ...
        blocks: [
          { opcode: "reset", blockType: BlockType.COMMAND, text: "reset all" },
          {
            ...
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "textureCostume",
            blockType: BlockType.COMMAND,
            text: "Set texture of object [NAME] to [COSTUME]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              COSTUME: { type: S, defaultValue: "costume1" },
            },
          },
          {
            opcode: "textureURL",
            blockType: BlockType.COMMAND,
            text: "Load texture for object [NAME] from URL [URL]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              URL: { type: S, defaultValue: "https://example.com/test.png" },
            },
          },
          {
            opcode: "modelList",
            blockType: BlockType.COMMAND,
            text: "Set model of object [NAME] from list [LIST]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              LIST: { type: S, defaultValue: "list1" },
            },
          },
          {
            opcode: "remove",
          ...
          "---",
          {
            opcode: "setPosition",
            blockType: BlockType.COMMAND,
            text: "Set position of object [NAME] to x [X] y [Y] z [Z]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              X: { type: N, defaultValue: 0 },
              Y: { type: N, defaultValue: 0 },
              Z: { type: N, defaultValue: 0 },
            },
          },
          {
            opcode: "setPositionX",
            blockType: BlockType.COMMAND,
            text: "Set x position of object [NAME] to [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 0 },
            },
          },
          {
            opcode: "setPositionY",
            blockType: BlockType.COMMAND,
            text: "Set y position of object [NAME] to [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 0 },
            },
          },
          {
            opcode: "setPositionZ",
            blockType: BlockType.COMMAND,
            text: "Set z position of object [NAME] to [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 0 },
            },
          },
          {
            ...
            blockType: BlockType.COMMAND,
            text: "Change x position of object [NAME] by [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          },
          {
            opcode: "changePositionY",
            blockType: BlockType.COMMAND,
            text: "Change y position of object [NAME] by [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          },
          {
            ...
            blockType: BlockType.COMMAND,
            text: "Change z position of object [NAME] by [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          },
          {
            opcode: "setRotation",
            blockType: BlockType.COMMAND,
            text: "Set rotation of object [NAME] to x [X] y [Y] z [Z]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              X: { type: N, defaultValue: 0 },
              Y: { type: N, defaultValue: 0 },
          ...
          },
          {
            opcode: "setRotationX",
            blockType: BlockType.COMMAND,
            text: "Set x rotation of object [NAME] to [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 0 },
            },
          },
          {
            opcode: "setRotationY",
            blockType: BlockType.COMMAND,
            text: "Set y rotation of object [NAME] to [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 0 },
            },
          },
          {
            opcode: "setRotationZ",
            blockType: BlockType.COMMAND,
            text: "Set z rotation of object [NAME] to [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 0 },
            },
          },
          {
            ...
            blockType: BlockType.COMMAND,
            text: "Rotate object [NAME] around its local x axis by [VALUE] degrees",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          },
          {
            ...
            blockType: BlockType.COMMAND,
            text: "Rotate object [NAME] around its local y axis by [VALUE] degrees",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          },
          {
            ...
            blockType: BlockType.COMMAND,
            text: "Rotate object [NAME] around its local z axis by [VALUE] degrees",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          ...
          {
            opcode: "changeRotationXWorld",
            blockType: BlockType.COMMAND,
            text: "Rotate object [NAME] around world x axis by [VALUE] degrees (not relative to object orientation)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          ...
          {
            opcode: "changeRotationYWorld",
            blockType: BlockType.COMMAND,
            text: "Rotate object [NAME] around world y axis by [VALUE] degrees (not relative to object orientation)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          ...
          {
            opcode: "changeRotationZWorld",
            blockType: BlockType.COMMAND,
            text: "Rotate object [NAME] around world z axis by [VALUE] degrees (not relative to object orientation)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          },
          {
            opcode: "setScale",
            blockType: BlockType.COMMAND,
            text: "Set scale of object [NAME] to x [X] y [Y] z [Z] (%)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              X: { type: N, defaultValue: 100 },
              Y: { type: N, defaultValue: 100 },
              Z: { type: N, defaultValue: 100 },
            },
          },
          {
            opcode: "setScaleX",
            blockType: BlockType.COMMAND,
            text: "Set x scale of object [NAME] to [VALUE] (%)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 100 },
            },
          },
          {
            opcode: "setScaleY",
            blockType: BlockType.COMMAND,
            text: "Set y scale of object [NAME] to [VALUE] (%)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 100 },
            },
          },
          {
            opcode: "setScaleZ",
            blockType: BlockType.COMMAND,
            text: "Set z scale of object [NAME] to [VALUE] (%)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 100 },
            },
          },
          {
            opcode: "changeScaleX",
            blockType: BlockType.COMMAND,
            text: "Change x scale of object [NAME] by [VALUE] (%)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 10 },
            },
          },
          {
            opcode: "changeScaleY",
            blockType: BlockType.COMMAND,
            text: "Change y scale of object [NAME] by [VALUE] (%)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 10 },
            },
          },
          {
            opcode: "changeScaleZ",
            blockType: BlockType.COMMAND,
            text: "Change z scale of object [NAME] by [VALUE] (%)",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 10 },
            },
          },
          {
            opcode: "moveSteps",
            blockType: BlockType.COMMAND,
            text: "Move object [NAME] forward by [STEPS] steps",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              STEPS: { type: N, defaultValue: 10 },
            },
          },
          {
            opcode: "moveToward",
            blockType: BlockType.COMMAND,
            text: "Move object [NAME] toward x [X] y [Y] z [Z] by [STEPS] steps",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              X: { type: N, defaultValue: 0 },
              Y: { type: N, defaultValue: 0 },
          ...
          },
          {
            opcode: "pointObject",
            blockType: BlockType.COMMAND,
            text: "Point object [NAME] toward object [TARGET]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              TARGET: { type: S, defaultValue: "target" },
            },
          },
          {
            opcode: "pointXYZ",
            blockType: BlockType.COMMAND,
            text: "Point object [NAME] toward x [X] y [Y] z [Z]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              X: { type: N, defaultValue: 0 },
              Y: { type: N, defaultValue: 0 },
          ...
          },
          {
            opcode: "glide",
            blockType: BlockType.COMMAND,
            text: "Glide object [NAME] to x [X] y [Y] z [Z] in [SECONDS] seconds",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              SECONDS: { type: N, defaultValue: 1 },
              X: { type: N, defaultValue: 0 },
              Y: { type: N, defaultValue: 0 },
              Z: { type: N, defaultValue: 0 },
            },
          ...
          "---",
          {
            opcode: "useCamera",
            blockType: BlockType.COMMAND,
            text: "Make object [NAME] the view camera",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "setColor",
            blockType: BlockType.COMMAND,
            text: "Set color of object [NAME] to [COLOR]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              COLOR: { type: C, defaultValue: "#ffffff" },
            },
          },
          {
            opcode: "setOpacity",
            blockType: BlockType.COMMAND,
            text: "Set opacity of object [NAME] to [VALUE] %",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 0 },
            },
          ...
          {
            opcode: "setPassThrough",
            blockType: BlockType.COMMAND,
            text: "Set pass-through of object [NAME] to [STATE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              STATE: { type: S, menu: "onoff" },
            },
          },
          {
            opcode: "setPhysics",
            blockType: BlockType.COMMAND,
            text: "Set physics of object [NAME] to [STATE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              STATE: { type: S, menu: "onoff" },
            },
          },
          {
            opcode: "bounce",
            blockType: BlockType.COMMAND,
            text: "Bounce object [NAME] if it touches another object",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "isTouching",
            blockType: BlockType.BOOLEAN,
            text: "Object [NAME] is touching object [TARGET]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              TARGET: { type: S, defaultValue: "target" },
            },
          ...
          },
          {
            ...
            blockType: BlockType.COMMAND,
            text: "Set fog distance to [VALUE]",
            arguments: { VALUE: { type: N, defaultValue: 100 } },
          },
          {
            opcode: "setFogColor",
            blockType: BlockType.COMMAND,
            text: "Set fog color to [COLOR]",
            arguments: { COLOR: { type: C, defaultValue: "#ffffff" } },
          },
          {
            opcode: "setFog",
            blockType: BlockType.COMMAND,
            text: "Set fog to [STATE]",
            arguments: { STATE: { type: S, menu: "onoff" } },
          },
          "---",
          {
            opcode: "setLight",
            blockType: BlockType.COMMAND,
            text: "Set object [NAME] as a light [STATE]",
            arguments: {
              NAME: { type: S, defaultValue: "light" },
              STATE: { type: S, menu: "onoff" },
            },
          },
          {
            ...
            blockType: BlockType.COMMAND,
            text: "Set light intensity of object [NAME] to [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "light" },
              VALUE: { type: N, defaultValue: 10 },
            },
          },
          {
            ...
            blockType: BlockType.COMMAND,
            text: "Set light color of object [NAME] to [COLOR]",
            arguments: {
              NAME: { type: S, defaultValue: "light" },
              COLOR: { type: C, defaultValue: "#ffffff" },
            },
          },
          {
            ...
            blockType: BlockType.COMMAND,
            text: "Set reflectivity of object [NAME] to [VALUE]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              VALUE: { type: N, defaultValue: 1 },
            },
          ...
          {
            opcode: "setRTXShadows",
            blockType: BlockType.COMMAND,
            text: "Set RTX shadows to [STATE]",
            arguments: { STATE: { type: S, menu: "onoff" } },
          },
          "---",
          {
            ...
            text: "Object [NAME] x position",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "getPositionY",
            blockType: BlockType.REPORTER,
            text: "Object [NAME] y position",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "getPositionZ",
            blockType: BlockType.REPORTER,
            text: "Object [NAME] z position",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "getRotationX",
            blockType: BlockType.REPORTER,
            text: "Object [NAME] x rotation",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "getRotationY",
            blockType: BlockType.REPORTER,
            text: "Object [NAME] y rotation",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "getRotationZ",
            blockType: BlockType.REPORTER,
            text: "Object [NAME] z rotation",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "getScaleX",
            blockType: BlockType.REPORTER,
            text: "Object [NAME] x scale (%)",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "getScaleY",
            blockType: BlockType.REPORTER,
            text: "Object [NAME] y scale (%)",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "getScaleZ",
            blockType: BlockType.REPORTER,
            text: "Object [NAME] z scale (%)",
            arguments: { NAME: { type: S, defaultValue: "box" } },
          },
          {
            opcode: "distance",
            blockType: BlockType.REPORTER,
            text: "Distance from object [NAME] to object [TARGET]",
            arguments: {
              NAME: { type: S, defaultValue: "box" },
              TARGET: { type: S, defaultValue: "target" },
            },
    ...
    setRotation(a) {
      ...
      if (o)
        o.rotation.set(
          THREE.MathUtils.degToRad(num(a.X)),
          THREE.MathUtils.degToRad(num(a.Y)),
          THREE.MathUtils.degToRad(num(a.Z))
        );
    }
    setRotationX(a) {
      const o = object(a.NAME);
    ...
    changeRotationX(a) {
      const o = object(a.NAME);
      if (o) {
        _deltaQuat.setFromAxisAngle(
          _localAxisX,
          THREE.MathUtils.degToRad(num(a.VALUE))
        );
    ...
    moveToward(a) {
      const o = object(a.NAME);
      if (o) {
        const d = new THREE.Vector3(num(a.X), num(a.Y), num(a.Z))
          .sub(o.position)
          .normalize();
        o.position.addScaledVector(d, num(a.STEPS) / 10);
      }
    ...
    glide(a, util) {
      ...
      const t = Math.min(
        1,
        (performance.now() - util.stackFrame.start) / (seconds * 1000)
      );
      o.position.lerpVectors(
        util.stackFrame.from,
        new THREE.Vector3(num(a.X), num(a.Y), num(a.Z)),
        t
      );
      if (t < 1) util.yield();
    }
      ...
      for (const other of objects.values()) {
        if (other !== o && touching(o, other)) {
          ...
          if (
            ...
            o.position.x += Math.sign(delta.x || 1) * 0.2;
          else if (Math.abs(delta.y) >= Math.abs(delta.z))
            o.position.y += Math.sign(delta.y || 1) * 0.2;
    ...
    setRTXShadows(a) {
      ...
      glRenderer.shadowMap.type = rtxShadows
    ...
    async textureCostume(a, util) {
      const o = object(a.NAME);
      if (!o) return;
      const costume = util.target.sprite.costumes.find(
        (c) => c.name === name(a.COSTUME)
      );
    ...
    async modelList(a, util) {
      ...
      if (
        items.every(
          (v) =>
            Number.isFinite(Number(v)) && Number(v) >= 0 && Number(v) <= 255
        )
      ) {
