...
"data:image/svg+xml;base64,";
  ...
  class HyperSenseSP {
      ...
      return {
        ...
        blocks: [
          ...
          "---",
          {
            ...
            isEdgeActivated: false,
            arguments: {
              KEY: { type: Scratch.ArgumentType.STRING, menu: "keys", defaultValue: "Tab" }
            }
          },
          {
            opcode: "isKeyPressed",
    ...
    handleScroll = (event) => {
      ...
      if (this.scrollWheelBool({ EVENT: "up", SECRET: true })) runtime.startHats("HyperSenseSP_scrollWheelHat", { EVENT: "up" });
    ...
    scrollWheelBool(args, util) {
      ...
      if (args.SECRET) oldVal = oldScroll[0];
        ...
        if (util.thread.stackFrames[0].oldVal === undefined) util.thread.stackFrames[0].oldVal = 0;
        oldVal = util.thread.stackFrames[0].oldVal;
      }
      const status = args.EVENT === "down" ? scrollDist > oldVal : scrollDist < oldVal;
      if (status) {
    ...
    advancedAskReporter(args, util) {
      return this.advancedAsk(args, util).then(() => { return runtime.ext_scratch3_sensing.getAnswer() });
    }
    ...
    currentTyped() {
      let box = document.querySelector(typeof scaffolding !== "undefined" ? `input[class="sc-question-input"]` : `div[class*="question"] [class^="input_input-form"]`);
    ...
    setAskType(args) {
      ...
      if (args.TYPE === "dropdown") {
        ...
        dropdown.addEventListener("change", () => { box.value = dropdown.value });
        const button = document.querySelector(`button[class*="question-submit-button"]`);
        button.addEventListener("click", () => {
          setTimeout(() => { runtime.ext_scratch3_sensing._answer = box.value }, 10);
        });
      } else {
        box.type = args.TYPE;
    ...
    screenOff() { return render.canvas.getBoundingClientRect().width / runtime.stageWidth }
    ...
    averageMicrophoneLoudness() {
      ...
      let sum = loudnessArray.reduce((accumulator, curValue) => accumulator + curValue, 0);
