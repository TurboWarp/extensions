...
// Description: Better Video Sensing Extension
// By: SharkPool
...
(function(Scratch) {
  "use strict";
  if (!Scratch.extensions.unsandboxed) throw new Error("Video Sensing+ must run unsandboxed");
...
"data:image/svg+xml;base64,";
  ...
  class VideoSensingPlus {
    ...
    videoTarget(args, util) {
      ...
      if (this.OGvideoID === -1) this.OGvideoID = vm.runtime.ioDevices.video._drawable;
      ...
      if (args.ON_OFF === "on") {
        if (!this.mediaStream) {
          try {
            ...
            runtime.startHats("VideoSensingPlusSP_whenCamera", { ON_OFF : "on" });
          } catch (error) {
