...
(function (Scratch) {
  "use strict";
  if (!Scratch.extensions.unsandboxed) throw new Error("Sprite Effects V2 must run unsandboxed");
...
"data:image/svg+xml;base64,";
  ...
  const purifySettings = {
    ...
    ADD_TAGS: [
      ...
      "feMorphology", "feOffset", "fePointLight", "feTurbulence",
      "feSpecularLighting", "feSpotLight", "feTile", "feDropShadow"
    ],
    ADD_ATTR: [
      "in", "in2", "result", "type", "values", "mode", "operator",
      "x", "y", "width", "height", "stdDeviation", "radius",
      "dx", "dy", "scale", "surfaceScale", "diffuseConstant", "specularConstant",
      "specularExponent", "kernelMatrix", "order", "divisor", "bias",
      "targetX", "targetY", "edgeMode", "preserveAlpha",
      "baseFrequency", "numOctaves", "seed", "stitchTiles",
      "lighting-color", "kernelUnitLength", "color-interpolation-filters",
      "azimuth", "elevation", "x1", "y1", "z1", "x2", "y2", "z2",
      "pointsAtX", "pointsAtY", "pointsAtZ", "xlink:href",
      "tableValues", "intercept", "amplitude", "exponent", "offset", "slope", "type",
      "filterUnits", "primitiveUnits", "patternUnits", "patternTransform"
    ]
  };

  const CANVAS_SVG = "<svg>CANVAS</svg>"; // used for canvas-specific filters

  const filterDOM = document.createElementNS("http://www.w3.org/2000/svg", "svg");
  ...
  const purifyFilter = (id, filterString, blockID, container) => {
    ...
    */
    ...
    if (opcode.startsWith("SPspriteEffectsV2_") && !opcode.endsWith("applyCustom")) {
      // this is safe.
  ...
  */
  ...
  if (!isPackagedEnv && typeof ReduxStore === "object") {
    ...
    ReduxStore.subscribe(() => {
      ...
      if (
        wasInEditor !== update.editor || wasPlayer !== update.player ||
  ...
  class SPspriteEffectsV2 {
    ...
    getInfo() {
      return {
        ...
        blocks: [
          ...
          { blockType: Scratch.BlockType.LABEL, text: Scratch.translate("Canvas Effects") },
          {
            opcode: "addCanvasFilter",
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate("apply filter [FILTER] with name [NAME] to canvas"),
            arguments: {
              FILTER: { /* let the user infer to drop a block here */ },
              NAME: {
          ...
          { blockType: Scratch.BlockType.LABEL, text: Scratch.translate("Basic Filters") },
          {
            opcode: "targetAsSVG",
          ...
          },
          {
            ...
            arguments: {
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "data.uri" }
            },
          },
          {
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add pixelation to [SRC] with [NUM] bits at [SIZE] %"),
            arguments: {
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
          ...
          },
          {
            opcode: "applyShadow",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add [COLOR] shadow to [SRC] at x [x] y [y] at [NUM] %"),
            arguments: {
              COLOR: { type: Scratch.ArgumentType.COLOR },
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
          ...
          { blockType: Scratch.BlockType.LABEL, text: Scratch.translate("Advanced Filters") },
          {
            opcode: "applyColorSplit",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add [TYPE] to [SRC] at x [x] y [y] using [COL1] [COL2] [COL3]"),
            arguments: {
              TYPE: { type: Scratch.ArgumentType.STRING, menu: "SPLIT_MODES" },
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
              x: { type: Scratch.ArgumentType.NUMBER, defaultValue: 10 },
              y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
              COL1: { type: Scratch.ArgumentType.COLOR, defaultValue: "#ff0000" },
              COL2: { type: Scratch.ArgumentType.COLOR, defaultValue: "#00ff00" },
              COL3: { type: Scratch.ArgumentType.COLOR, defaultValue: "#0000ff" }
            },
          },
          {
            opcode: "applyWave",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add wave to [SRC] on [AXIS] at x [x] y [y] seed [SEED]"),
            arguments: {
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
          ...
          },
          {
            opcode: "applyGlitch",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add glitch to [SRC] on [AXIS] with [LINE] lines offset x [x] y [y] thickness [NUM]"),
            arguments: {
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
              AXIS: { type: Scratch.ArgumentType.STRING, menu: "AXISES" },
          ...
          },
          {
            opcode: "applyVHS",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add vhs to [SRC] on [AXIS] offset x [x] y [y] at [NUM]%"),
            arguments: {
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
              AXIS: { type: Scratch.ArgumentType.STRING, menu: "AXISES" },
              x: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
          ...
          },
          {
            opcode: "applyTile",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add mosaic to [SRC] at x [x] y [y] size [NUM] %"),
            arguments: {
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
              NUM: { type: Scratch.ArgumentType.NUMBER, defaultValue: 15 },
              x: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
          ...
          "---",
          {
            ...
            arguments: {
              TYPE: { type: Scratch.ArgumentType.STRING, menu: "DISTORT_PRESETS" }
            },
          },
          {
            opcode: "applyDistortion",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add [MAP] distortion to [SRC] at x [x] y [y] size [SIZE] intensity [NUM]"),
            arguments: {
              MAP: { type: Scratch.ArgumentType.STRING, defaultValue: "preset / </svg> / data.uri" },
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
              x: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
              y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
          ...
          },
          {
            opcode: "applyCustom",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add custom [FILTER] with name [NAME] to [SRC]"),
            arguments: {
              FILTER: { type: Scratch.ArgumentType.STRING, defaultValue: Scratch.translate("svg filter") },
              NAME: { type: Scratch.ArgumentType.STRING, defaultValue: Scratch.translate("my-filter") },
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" }
            },
          },
          { blockType: Scratch.BlockType.LABEL, text: Scratch.translate("Lighting") },
          {
            opcode: "applyBasicLight",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add [COLOR] light to [SRC] at x [x] y [y] z [z] intensity [NUM]"),
            arguments: {
              COLOR: { type: Scratch.ArgumentType.COLOR },
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
              x: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("add light to [SRC] using map [MAP] with [BLEND] mode"),
            arguments: {
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
          ...
          { blockType: Scratch.BlockType.LABEL, text: Scratch.translate("Transformations") },
          {
            opcode: "applyPattern",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("replace [COLOR] with pattern [PAT] scale [SIZE] in [SRC]"),
            arguments: {
          ...
          "---",
          {
            opcode: "applyMask",
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate("[TYPE] mask [MASK] from [SRC] at x [x] y [y] width [W] height [H]"),
            arguments: {
              TYPE: { type: Scratch.ArgumentType.STRING, menu: "MASK_TYPES" },
              MASK: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg> / data.uri" },
              SRC: { type: Scratch.ArgumentType.STRING, defaultValue: "</svg>" },
              x: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
              y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
        ...
        menus: {
          ...
          MASK_TYPES: {
            acceptReporters: false,
            items: [
              genMenuItem("erase"), genMenuItem("cutout"),
          ...
          BLUR_TYPES: {
            acceptReporters: true,
            items: [genMenuItem("motion blur", "motion"), genMenuItem("vintage blur", "vintage")]
          },
          EFFECTS: {
            acceptReporters: true,
            items: [
              genMenuItem("blur"), genMenuItem("color"),
              genMenuItem("saturation"), genMenuItem("contrast"),
              genMenuItem("brightness"), genMenuItem("sepia"),
              genMenuItem("bloom"), genMenuItem("bloom v2"),
              genMenuItem("amplify"), genMenuItem("discrete"),
              genMenuItem("thermal"), genMenuItem("posterize"),
              genMenuItem("inflate"), genMenuItem("bevel"),
              genMenuItem("liquify"), genMenuItem("erode"),
              genMenuItem("torn"), genMenuItem("disolve"),
              genMenuItem("displacement"), genMenuItem("grain")
            ],
          },
          DISTORT_PRESETS: {
            acceptReporters: true,
            items: [
              genMenuItem("bulge"), genMenuItem("whirl"),
              genMenuItem("ripple"),
          ...
          BLEND_MODES: {
            ...
            items: [
              genMenuItem("normal"),
              genMenuItem("multiply"), genMenuItem("screen"),
              genMenuItem("overlay"), genMenuItem("exclusion"),
              genMenuItem("color-dodge"), genMenuItem("color-burn"),
              genMenuItem("hard-light"), genMenuItem("soft-light"),
              genMenuItem("difference"), genMenuItem("luminosity")
            ]
          },
          LIGHT_MODES: {
            acceptReporters: true,
            items: [
              genMenuItem("multiply"), genMenuItem("screen"),
              genMenuItem("darken"), genMenuItem("lighten"),
              genMenuItem("overlay"),
              genMenuItem("hard-light"), genMenuItem("soft-light"),
              genMenuItem("difference"), genMenuItem("exclusion"),
              genMenuItem("hue"), genMenuItem("saturation"),
              genMenuItem("color"), genMenuItem("luminosity")
            ]
          }
        },
      };
    ...
    _getTargetAssetSVG(target) {
      ...
      if (runtime.isPackaged) {
        ...
        if (isSVG) {
          ...
          const gl = render.gl;
          const width = skin.size[0] * 2, height = skin.size[1] * 2;
    ...
    _safeConvert(src) {
      if (src.startsWith("data:image/") || src.startsWith("https://")) return src;
      if (this._isSVG(src)) {
    ...
    async _unknownToPNG(src, ignorePrePNG) {
      if (
        !ignorePrePNG && src.startsWith("data:image/") &&
    ...
    _injectFilter(svg, name, filter) {
      ...
      filter = filter.replace("<filter", `<filter id="${name}" filterUnits="userSpaceOnUse"`);
    ...
    addCanvasFilter(args, util) {
      ...
      if (verified && verified[1]) {
        ...
        const filter = purifyFilter(properId, filterString, thisBlock, container);
        if (!filter) return;
    ...
    targetAsSVG(args, util) {
      ...
      if (target === "_stage_") return this._getTargetAssetSVG(runtime.getTargetForStage());
    ...
    async imageAsSVG(args) {
      ...
      return new Promise((resolve) => {
        ...
        img.onload = () => {
          ...
          resolve(`<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" `
    ...
    applySimpleEffect(args) {
      ...
      switch (Cast.toString(args.EFFECT)) {
        case "blur":
          return this._injectFilter(
            svg, "blur",
            `<filter><feGaussianBlur stdDeviation="${Math.abs(amt)}" in="SourceGraphic"></feGaussianBlur></filter>`
          );
        case "color":
          return this._injectFilter(
            svg, "color",
        ...
        case "saturation":
          ...
          return this._injectFilter(
            svg, "saturate",
            `<filter>${seed}<feColorMatrix type="saturate" values="${amt / 100}"></feColorMatrix></filter>`
          );
        case "contrast":
          amt = (amt + 100) / 100;
          return this._injectFilter(
        ...
        case "sepia":
          ...
          return this._injectFilter(
            svg, "sepia",
            `<filter><feColorMatrix type="matrix" values="${0.393 * amt} ${0.769 * amt} ${0.189 * amt} 0 0 ${0.349 * amt} ${0.686 * amt} ${0.168 * amt} 0 0 ${0.272 * amt} ${0.534 * amt} ${0.131 * amt} 0 0 0 0 0 1 0"></feColorMatrix></filter>`
          );
        case "bloom":
          return this._injectFilter(
            svg, "bloom",
            `<filter><feGaussianBlur in="SourceGraphic" stdDeviation="5"/><feComposite in2="SourceGraphic" operator="arithmetic" k2="${amt / 100}" k3="1"/></filter>`
          );
        case "bloom v2":
          return this._injectFilter(
            svg, "bloom-v2",
            `<filter><feGaussianBlur in="SourceGraphic" stdDeviation="5"/><feComposite in2="SourceGraphic" operator="arithmetic" k2="${amt / 100}" k3="1" color-interpolation-filters="sRGB"/></filter>`
          );
        case "amplify":
          amt = (amt + 100) / 100;
          return this._injectFilter(
        ...
        case "torn":
          return this._injectFilter(
            svg, "torn",
            `<filter><feOffset in="SourceGraphic" dx="${amt / -4}" dy="${amt / -4}" result="offsetRes"/><feTurbulence type="turbulence" baseFrequency="0.05" numOctaves="2" result="turbulence"/><feDisplacementMap in2="turbulence" in="offsetRes" scale="${amt}" xChannelSelector="R" yChannelSelector="G"/></filter>`
          );
        case "bevel":
          return this._injectFilter(
            svg, "bevel",
            `<filter><feGaussianBlur stdDeviation="${Math.abs(amt / 10)}" in="SourceAlpha" result="BLUR"/><feSpecularLighting surfaceScale="2" specularConstant="2" specularExponent="20" lighting-color="#fff" in="BLUR" result="SPEC"><fePointLight x="40" y="-30" z="50"/></feSpecularLighting><feComposite operator="in" in="SPEC" in2="SourceAlpha" result="COMP"/><feMerge><feMergeNode in="SourceGraphic"/><feMergeNode in="COMP"/></feMerge></filter>`
          );
        case "inflate":
          return this._injectFilter(
            svg, "inflate",
            `<filter><feMorphology in="SourceGraphic" operator="dilate" radius="${Math.abs(amt / 10)}"></feMorphology></filter>`
          );
        case "liquify":
        ...
        case "thermal":
          amt /= 10;
          seed = [`0 0.125 ${0.8 * amt} ${amt} ${amt}`, `0 0 0 ${0.843 * amt} 1`, `0 ${0.549 * amt} ${0.466 * amt} 0 1`];
          return this._injectFilter(
            svg, "thermal",
        ...
        case "erode":
          return this._injectFilter(
            svg, "erode",
            `<filter><feMorphology in="SourceGraphic" operator="erode" radius="${Math.abs(amt / 10)}"></feMorphology></filter>`
          );
        case "disolve":
          return this._injectFilter(
            svg, "disolve",
        ...
        case "displacement":
          return this._injectFilter(
            svg, "displace",
            `<filter><feOffset dx="${amt / -3}" dy="${amt / -3}" result="off"/><feTurbulence type="turbulence" baseFrequency="${svg === CANVAS_SVG ? 1 : 100}" id="turbulence" numOctaves="1" result="turb"></feTurbulence><feDisplacementMap in="off" in2="turb" scale="${amt}" xChannelSelector="A" yChannelSelector="A"/></filter>`
          );
        case "grain":
          if (amt === 0) return svg;
          ...
          return this._injectFilter(
            svg, "grain",
            `<filter><feTurbulence type="fractalNoise" baseFrequency="${amt / 100}" numOctaves="3" result="turbulence" seed="${seed}"/><feColorMatrix in="turbulence" type="saturate" values="0" result="grain"/><feComposite in="grain" in2="SourceGraphic" operator="in"/><feComposite in="0.5" in2="SourceGraphic" operator="over"/></filter>`
          );
        default: return svg;
      }
    }
    ...
    applySpecialBlur(args) {
      ...
      const filter = isMotion ?
        `<filter><feGaussianBlur stdDeviation="${Math.abs(x)},${Math.abs(y)}" in="SourceGraphic"></feGaussianBlur></filter>`
    ...
    applyOutline(args) {
      ...
      if (isFlood) {
        ...
        if (compatMode) filter = `<filter><feMorphology operator="dilate" radius="${amt}" in="SourceAlpha" result="thickened"/><feFlood flood-color="${color}" result="flood"/><feComposite operator="in" in="flood" in2="thickened"/><feComposite operator="over" in="SourceGraphic"/></filter>`;
        else filter = `<filter><feMorphology operator="erode" radius="${amt}" in="SourceAlpha" result="thickened"/><feFlood flood-color="${color}" result="flood"/><feComposite operator="xor" in="flood" in2="thickened" result="frame"/><feComposite operator="atop" in="frame" in2="SourceGraphic"/></filter>`;
      }
    ...
    applyColorSplit(args) {
      ...
      switch (Cast.toString(args.TYPE)) {
        case "split":
          return this._injectFilter(
            svg, "add-split",
            `<filter><feFlood flood-color="${colors[0]}" flood-opacity="0.5" result="RED"/><feFlood flood-color="${colors[1]}" flood-opacity="0.5" result="GREEN"/><feFlood flood-color="${colors[2]}" flood-opacity="0.5" result="BLUE"/><feComposite operator="in" in="RED" in2="SourceAlpha" result="RED"/><feComposite operator="in" in="GREEN" in2="SourceAlpha" result="GREEN"/><feComposite operator="in" in="BLUE" in2="SourceAlpha" result="BLUE"/><feOffset in="RED" dx="${x * -1}" dy="${y}" result="RED_OFF"/><feOffset in="GREEN" dx="${x}" dy="${y * -1}" result="GREEN_OFF"/><feOffset in="BLUE" dx="0" dy="0" result="BLUE_OFF"/><feBlend mode="screen" in="RED_OFF" in2="GREEN_OFF" result="RG"/><feBlend mode="screen" in="RG" in2="BLUE_OFF" result="FINAL_RESULT"/></filter>`
          );
        case "overlay":
          return this._injectFilter(
            svg, "over-split",
            `<filter><feFlood flood-color="${colors[0]}" flood-opacity="0.5" result="RED"/><feFlood flood-color="${colors[1]}" flood-opacity="0.5" result="GREEN"/><feComposite operator="in" in="SourceGraphic" in2="SourceAlpha" result="BLUE" /><feComposite operator="in" in="RED" in2="SourceAlpha" result="RED"/><feComposite operator="in" in="GREEN" in2="SourceAlpha" result="GREEN"/><feComposite operator="in" in="BLUE" in2="SourceAlpha" result="BLUE"/><feOffset in="RED" dx="${x * -1}" dy="${y}" result="RED_OFF"/><feOffset in="GREEN" dx="${x}" dy="${y * -1}" result="GREEN_OFF"/><feOffset in="BLUE" dx="0" dy="0" result="BLUE_OFF"/><feBlend mode="screen" in="RED_OFF" in2="GREEN_OFF" result="RG"/><feBlend mode="screen" in="RG" in2="BLUE_OFF" result="FINAL_RESULT"/><feComposite operator="over" in="SourceGraphic" in2="FINAL_RESULT" /></filter>`
          );
        case "chroma":
          return this._injectFilter(
            svg, "aberration",
            `<filter><feOffset in="SourceGraphic" dx="${x}" dy="${y}" result="layer-one" /><feColorMatrix in="layer-one" result="customColor1" type="matrix" values="${this._hexValueMap(colors[0])}"></feColorMatrix><feOffset in="SourceGraphic" dx="${x * -1}" dy="${y * -1}" result="layer-two" /><feColorMatrix in="layer-two" result="customColor2" type="matrix" values="${this._hexValueMap(colors[1])}"></feColorMatrix><feBlend in="customColor1" in2="customColor2" mode="screen" result="color-split" /></filter>`
          );
        default: return svg;
      }
    }
    ...
    applyGlitch(args) {
      ...
      size = [
        axis[0] ? size : multiplier,
        axis[1] ? size : multiplier
      ];
      ...
      for (let i = 1; i < lineCount; i++) {
        ...
        mergeTxt += `<feOffset in="SourceGraphic" dx="${x * rng()}" dy="${y * rng()}" result="off${i}"/>`;
        mergeTxt += `<feMerge x="${axis[0] ? Math.random() * multiplier : 0}%" y="${axis[1] ? Math.random() * multiplier : 0}%" width="${size[0]}%" height="${size[1]}%" result="merge${i}">`;
    ...
    applyVHS(args) {
      ...
      const mul = svg !== CANVAS_SVG ? [100, 100] :
        [runtime.stageHeight * fsRatio, runtime.stageWidth * fsRatio]

      let axis = Cast.toString(args.AXIS);
      axis = axis === "x" ? [true, false] : axis === "y" ? [false, true] : [true, true];

      const filter = `<filter><feOffset in="SourceGraphic" dx="${x}" dy="${y}" result="off"/>`
        + `<feMerge in="SourceGraphic" x="${axis[0] ? (100 - amt) * (mul[0] / 100) : 0}%" y="${axis[1] ? (100 - amt) * (mul[1] / 100) : 0}%" width="${axis[0] ? amt * mul[0] : mul[0]}%" height="${axis[1] ? amt * mul[1] : mul[1]}%" result="merge1">`
        + `<feMergeNode in="off" /><feMergeNode in="merge1"/></feMerge>`
        + `<feMerge in="off" x="0%" y="0%" width="${axis[0] ? mul[0] - amt : mul[0]}%" height="${axis[1] ? mul[1] - amt : mul[1]}%" result="merge2">`
        + `<feMergeNode in="SourceGraphic"/><feMergeNode in="merge2"/></feMerge>`
        + `<feMerge><feMergeNode in="merge1"/>${amt < 100 ? `<feMergeNode in="merge2"/>` : ""}</feMerge></filter>`;
    ...
    async applyTile(args) {
      ...
      if (canvasMode) {
        ...
        const tilePng = await this._svgToPNG(svg, scalars.width, scalars.height);
        return this._injectFilter(
          svg, "tile",
          `<filter><feImage x="${x}" y="${y}" width="${scalars.width / size}%" height="${scalars.width / size}%" xlink:href="${tilePng}"/><feTile/></filter>`
        );
      }
    }
    ...
    async applyDistortion(args) {
      ...
      const filter = `<filter xmlns:xlink="http://www.w3.org/1999/xlink">`
    ...
    applyCustom(args) {
      const svg = this._handleSVG(args.SRC);
      return this._injectFilter(svg, Cast.toString(args.NAME), Cast.toString(args.FILTER));
    }
    ...
    applyMapLight(args) {
      ...
      const mapScale = svg === CANVAS_SVG ? getCanvas().getBoundingClientRect() : this._getSize(svg);
    ...
    async applyPattern(args) {
      ...
      svg = `${svg.substring(0, svgTag + 1)}${definition}${svg.substring(svgTag + 1, svg.length)}`;
    ...
    applyMask(args) {
      ...
      const filter = `<filter>`
        ...
        + `<feComposite in="${method !== " " ? "SourceGraphic" : "image1"}" in2="${method !== " " ? "image1" : "SourceGraphic"}" operator="${method}" x="0%" y="0%" width="${maskScale[0]}" height="${maskScale[1]}"/></filter>`;
    ...
    applyTransforms(type, args) {
      ...
      switch (type) {
        ...
        case "DIR": {
          ...
          const rotWidth = Math.abs(width * Math.cos(rad)) + Math.abs(height * Math.sin(rad));
          const rotHeight = Math.abs(width * Math.sin(rad)) + Math.abs(height * Math.cos(rad));
      ...
      return this.expandViewBox({
        SRC: newSvg, x: xGrowth, y: yGrowth
      });
    }
  }
