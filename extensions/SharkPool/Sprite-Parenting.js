(function (Scratch) {
  ...
  //thank you DogeIsCut for the inspirtation behind the menu icon and the permission to take his idea and make it an extension :3
  const menuIconURI =
  ...
  class SPspriteParent {
    ...
    updateLink(args) {
      this.update(args.LINK, args.TYPE);
    }
    ...
    //thank you LilyMakesThings for this little piece of gold:
    _getTargets() {
      const spriteNames = [];
