(function(Scratch) {
  ...
  Scratch.translate.setup({
    ...
    zh: {
      ...
      addListToList:'在列表 [LIST] 末尾添加列表 [LIST2]',
  ...
  class VarAndList {
      ...
      return {
        ...
        blocks: [
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate({ id:'addListToList', default:'add list [LIST2] to [LIST]' }),
            arguments: {
              LIST: {
                type: Scratch.ArgumentType.STRING,
                defaultValue:'list'
          ...
          },
          {
            opcode:'reverseList',
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate({ id:'reverseList', default:'reverse [LIST1]' }),
            arguments: {
              LIST: {
                type: Scratch.ArgumentType.STRING,
                defaultValue:'list'
    ...
    addListToList(args, util) {
      /** @type {VM.ListVariable} */
      const variable = util.target.lookupVariableByNameAndType(Scratch.Cast.toString(args.LIST), 'list'),list2=Scratch.Cast.toString(args.LIST2);
      if (variable) {
        try {
