...
(function (Scratch) {
  ...
  class Matrix {
    ...
    getInfo() {
      return {
        id: 'qxsckmatrix',
        name: this.formatMessage('Matrix'),
        color1: '#6caa0e',
        color2: '#6caa0e',
        blockIconURI: Icon,
        menuIconURI: Icon,
        blocks: [
          //command,reporter,Boolean,hat,conditional,loop
          {
            opcode: 'isAMatrix',
            blockType: 'Boolean',
            text: this.formatMessage('[ARR] is matrix?'),
            arguments: {
              ARR: {
                type: 'string',
          ...
          },
          {
            opcode: 'matrixOper',
            blockType: 'reporter',
            text: this.formatMessage('matrix [ARR] [OPER] matrix [ARR2]'),
            arguments: {
              ARR: {
                type: 'string',
                defaultValue: '[[1,2],[3,4]]'
          ...
          },
          {
            opcode: 'matrixScalar',
            blockType: 'reporter',
            text: this.formatMessage('matrix [ARR] * [NUM]'),
            arguments: {
              ARR: {
                type: 'string',
                defaultValue: '[[1,2],[3,4]]'
          ...
          },
          {
            ...
            blockType: 'reporter',
            text: this.formatMessage('transpose matrix [ARR]'),
            arguments: {
              ARR: {
                type: 'string',
                defaultValue: '[[1,2],[3,4]]'
          ...
          },
          {
            opcode: 'matrixTrace',
            blockType: 'reporter',
            text: this.formatMessage('trace of matrix [ARR]'),
            arguments: {
              ARR: {
                type: 'string',
                defaultValue: '[[1,2],[3,4]]'
