...
(function(Scratch) {
    ...
    if (!Scratch.extensions.unsandboxed) {
        throw new Error('The Meteorology extension needs to be unsandboxed for proper use.');
    }
    ...
    class Meteorology {
        ...
        weatherjson(args) {
            return Scratch.fetch('https://api.weather.gov/points/' + args.LAT.toString() + ',' + args.LONG.toString())
                .then((response) => {
        ...
        weathertype(args) {
            return Scratch.fetch('https://api.weather.gov/points/' + args.LAT.toString() + ',' + args.LONG.toString())
                ...
                .then((data) => {
                    const weather = data.properties.weather.values[0].value[0][args.WEATHER]
