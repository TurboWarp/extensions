...
(function (Scratch) {
  ...
  class Wikipedia {
      ...
      return {
        ...
        blocks: [
          ...
          '---',
          {
            ...
            text: 'add the language [text] with the id [value]',
            arguments: {
              text: {
                type: Scratch.ArgumentType.STRING,
    ...
    getLanguage(args) {
      try {
        return json_array_filter('text', languages_list)[json_array_filter('value', languages_list).indexOf(this.wikipediaLanguages)];
      } catch {
        return '';
      }
    }
