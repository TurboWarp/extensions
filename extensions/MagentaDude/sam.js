...
(function(Scratch) {
    ...
    class SAM {
            ...
            return {
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'download speech of [SPEECH]',
                        arguments: {
                            SPEECH: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'Hello, my name is SAM.'
                ...
                menus: {
                    PROP_MENU: {
                        ...
                        items: ['speed', 'pitch', 'mouth', 'throat']
                    },
                    PRESET_MENU: {
                        acceptReporters: true,
                        items: ['SAM', 'elf', 'little robot', 'stuffy guy', 'little old lady', 'extra-terrestrial']
                    }
                }
            };
        }
        
        checkProps(util) { // Utility function to assign the sprite a voice if it doesn't have one
        ...
        downloadSpeech(args, util) {
            if (noDownload) {
                if (confirm('Do you want to allow this project to download voice clips to your computer?')) {
                    noDownload = false;
                } else {
                    return;
                }
