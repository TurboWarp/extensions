...
(function (Scratch) {
    ...
    const updateFrameAttributes = (id) => {
        ...
        const { iframe, x, y, width, height, interactive, resizeBehavior } = iframeData;
    ...
    window.addEventListener("message", (e) => {
        ...
        for (const id in iframes) {
            const iframeData = iframes[id];
            if (iframeData.iframe && iframeData.iframe.contentWindow && e.source === iframeData.iframe.contentWindow) {
                ...
                Scratch.vm.runtime.startHats("iframe_whenMessage", { IFRAME_ID: id });
                break;
            }
        }
    });
    ...
    class IframeExtension {
            ...
            return {
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: Scratch.translate("set iframe [ID] interactive to [INTERACTIVE]"),
                        arguments: {
                            ID: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: "iframe1",
                    ...
                    },
                    {
                        opcode: "setResize",
                        blockType: Scratch.BlockType.COMMAND,
                        text: Scratch.translate("set iframe [ID] resize behavior to [RESIZE]"),
                        arguments: {
                            ID: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: "iframe1",
        ...
        get({ ID, MENU }) {
            ...
            if (MENU === "url") {
                ...
                return !!iframeData.iframe && iframeData.iframe.style.display !== "none";
            } else if (MENU === "x") {
                return iframeData.x;
            } else if (MENU === "y") {
                return iframeData.y;
            } else if (MENU === "width") {
                return iframeData.width >= 0 ? iframeData.width : Scratch.vm.runtime.stageWidth;
            } else if (MENU === "height") {
                return iframeData.height >= 0 ? iframeData.height : Scratch.vm.runtime.stageHeight;
