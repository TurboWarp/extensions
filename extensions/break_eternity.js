// Name: Break Eternity
// ID: BrkEtt
// Description: A direct port of break_eternity.js to turbowarp.
// By: gum_gummi
...
(function (Scratch) {
  ...
  let Decimal = (function (global, factory) {
    ...
    var critical_tetr_values = [
      ...
      [
        ...
        1,
        1.1840100246247336, 1.406137583615695, 1.680227220886396,
        2.0267570283886189, 2.477005606344964, 3.0805252717554819,
        3.919196419262728, 5.135152840833186, 6.989961179534714, 10,
      ],
    ];
    ...
    function d_lambertw(z) {
      ...
      for (var i = 0; i < 100; ++i) {
        ...
        wn = w.sub(
          wewz.div(
            w.add(1).sub(w.add(2).mul(wewz).div(Decimal.mul(2, w).add(2)))
          )
        );
    ...
    var Decimal = /*#__PURE__*/ (function () {
      ...
      _createClass(
        ...
        */
                ...
                if (
                  this.sign === 0 ||
                  (this.mag === 0 && this.layer === 0) ||
                  (this.mag === Number.NEGATIVE_INFINITY &&
                    this.layer > 0 &&
                    Number.isFinite(this.layer))
                ) {
                  this.sign = 0;
                  this.mag = 0;
                  this.layer = 0;
                ...
                if (
                  Number.isNaN(this.sign) ||
                  Number.isNaN(this.layer) ||
                  Number.isNaN(this.mag)
                ) {
          ...
          },
          {
            ...
            value: function fromMantissaExponent_noNormalize(
              mantissa,
              exponent
            ) {
          ...
          },
          {
            ...
            value: function fromString(value) {
              ...
              if (ecount === 0) {
                ...
                if (
                  isFinite(_numberAttempt) &&
                  Math.abs(_numberAttempt) > 1e-307
                ) {
          ...
          },
          {
            ...
            value: function ceil() {
              if (this.mag < 0) {
                if (this.sign === 1)
                  return FC_NN(1, 0, 1); //The ceiling function called on something tiny like 10^10^-100 should return 1, since 10^10^-100 is still greater than 0
                else return FC_NN(0, 0, 0);
              }
          ...
          },
          {
            ...
            value: function add(value) {
              ...
              if (
                (this.eq(Decimal.dInf) && decimal.eq(Decimal.dNegInf)) ||
              ...
              if (layera === 0 && layerb === -1) {
                if (
                  Math.abs(b.mag - Math.log10(a.mag)) > MAX_SIGNIFICANT_DIGITS
                ) {
                  return a;
                } else {
              ...
              if (layera === 1 && layerb === 0) {
                if (
                  Math.abs(a.mag - Math.log10(b.mag)) > MAX_SIGNIFICANT_DIGITS
                ) {
                  return a;
                } else {
                  ...
                  return FC(
                    Math.sign(_mantissa),
                    1,
                    Math.log10(b.mag) + Math.log10(Math.abs(_mantissa))
                  );
                }
              }
              ...
              if (Math.abs(a.mag - b.mag) > MAX_SIGNIFICANT_DIGITS) {
                ...
                return FC(
                  Math.sign(_mantissa2),
                  1,
                  b.mag + Math.log10(Math.abs(_mantissa2))
                );
              }
            },
            /**
          ...
          },
          {
            ...
            value: function mod(value) {
              ...
              var vd = D(value);
              var decimal = vd.abs();
              if (this.eq(Decimal.dZero) || decimal.eq(Decimal.dZero))
                return FC_NN(0, 0, 0);

              if (floored) {
                var absmod = this.abs().mod(decimal);
                if ((this.sign == -1) != (vd.sign == -1))
                  absmod = vd.abs().sub(absmod);
          ...
          },
          {
            ...
            value: function cmp_tolerance(value, tolerance) {
              var decimal = D(value);
              return this.eq_tolerance(decimal, tolerance)
                ? 0
                : this.cmp(decimal);
            },
            /**
        ...
        */
          ...
          },
          {
            ...
            value: function root(value) {
              var decimal = D(value);
              if (this.lt(0) && decimal.mod(2, true).eq(1))
                return this.neg().root(decimal).neg();
            ...
            value: function tetrate() {
              ...
              if (
                  ...
                  (this.lte(1.4446678610097661) &&
                    payload.lte(
                      Decimal.ln(this)
                        .neg()
                        .lambertw(false)
                        .div(Decimal.ln(this).neg())
                    ))) &&
                (oldheight > 10000 || !linear)
              ) {
                ...
                if (payload.eq(Decimal.dOne)) payload = this.pow(fracheight);
                  ...
                  payload = payload
                    .pow(1 - fracheight)
                    .mul(this.pow(payload).pow(fracheight));
          ...
          },
          {
            ...
            value: function slog() {
              ...
              for (var i = 1; i < iterations; ++i) {
                var new_decimal = new Decimal(base).tetrate(
                  result,
                  Decimal.dOne,
                  linear
                );
          ...
          },
          {
            ...
            value: function layeradd(diff, base) {
              ...
              if (slogdest >= 0) {
                ...
                return Decimal.log(
                  Decimal.tetrate(base, slogdest + 1, Decimal.dOne, linear),
                  base
                );
              } else {
                return Decimal.log(
                  Decimal.log(
                    Decimal.tetrate(base, slogdest + 2, Decimal.dOne, linear),
                    base
                  ),
                  base
                );
            ...
            value:
              ...
              function lambertw() {
                ...
                if (this.lt(-0.3678794411710499)) {
                  ...
                  if (this.layer === 0) {
                    return Decimal.fromNumber(
                      f_lambertw(this.sign * this.mag, 1e-10, false)
                    );
                  } else if (this.layer == 1) {
            ...
            value: function linear_sroot(degree) {
              ...
              if (this.gt(1)) {
                ...
                while (loopGoing) {
                  ...
                  if (
                    Decimal.iteratedexp(10, layer, guess, true)
                      .tetrate(degree, 1, true)
                      .gt(this)
                  )
                    upper = guess;
                  else lower = guess;
                ...
                while (stage < 4) {
                  ...
                  while (_upper.neq(_lower)) {
                    ...
                    if (
                      _upper.pow10().recip().tetrate(degree, 1, true).eq(1) &&
                      _upper.pow10().recip().lt(0.4)
                    ) {
                      ...
                      _upper
                        ...
                        .tetrate(degree, 1, true)
                        .eq(
                          _upper.pow10().recip().mul(2).tetrate(degree, 1, true)
                        )
                    ) {
                      ...
                      while (
                        prevPoint
                          .tetrate(degree, 1, true)
                          .eq(_upperBound.tetrate(degree, 1, true)) ||
                        nextPoint
                          .tetrate(degree, 1, true)
                          .eq(_upperBound.tetrate(degree, 1, true)) ||
                      ...
                      if (
                        ...
                        stage == 3 &&
                        _upper.gt_tolerance(minimum, 1e-8)
                      ) {
                        ...
                        while (
                          prevPoint
                            .tetrate(degree, 1, true)
                            .eq_tolerance(
                              _upperBound.tetrate(degree, 1, true),
                              1e-8
                            ) ||
                          nextPoint
                            .tetrate(degree, 1, true)
              ...
              function pentate() {
                ...
                if (fracheight !== 0) {
                  if (payload.eq(Decimal.dOne)) {
                    ...
                    return this.pentate(
                      payload
                        .penta_log(this, undefined, linear)
                        .plus(oldheight)
                        .toNumber(),
                      1,
                      linear
                ...
                if (height > 0) {
                  for (var i = 0; i < height; ) {
                    ...
                    if (
                      ...
                      return this.tetrate(height - i, payload, linear); // End early if it's settled on a limit. Bases close to 0 alternate between two possible values.

                    if (
                      payload.eq(prevpayload) ||
                      (payload.eq(prevtwopayload) && i % 2 == height % 2)
                    )
                      return payload.normalize(); //bail if we're NaN
        ...
        Therefore, penta_root and sroot will return the same value. */
          ...
          },
          {
            ...
            value: function atanh() {
              ...
              return Decimal.ln(
                this.add(1).div(Decimal.fromNumber(1).sub(this))
              ).div(2);
            },
            /**
        ...
        [
          ...
          },
          {
            ...
            value: function efficiencyOfPurchase_core(
              cost,
              currentRpS,
              deltaRpS
            ) {
            ...
            value: function excess_slog(value, base) {
              ...
              if (value.gt(upper)) {
                ...
                if (value.gte(slogzero) && value.lt(slogone)) estimate = 0;
                  ...
                  while (payload.lt(value)) {
                    ...
                    if (payload.layer > 3) {
                      var layersleft = Math.floor(
                        value.layer - payload.layer + 1
                      );
                ...
                while (step_size > 1e-16) {
                  ...
                  if (guess.eq(value))
                    return [new Decimal(estimate + tested), 2];
                  else if (guess.lt(value)) fracheight += step_size;
                  step_size /= 2;
                }

                if (guess.neq_tolerance(value, 1e-7))
                  return [new Decimal(Decimal.dNaN), 0];
              ...
              if (value.lt(upper) && value.gt(lower)) {
                ...
                while (_step_size > 1e-16) {
                  ...
                  _towertop = _slogzero
                    .pow(1 - _tested)
                    .mul(_slogone.pow(_tested)); //Weighted geometric average

                  _guess2 = Decimal.iteratedexp(base, _estimate, _towertop);
                  if (_guess2.eq(value))
                    return [new Decimal(_estimate + _tested), 1];
                  else if (_guess2.gt(value)) _fracheight += _step_size;
                  _step_size /= 2;
                }

                if (_guess2.neq_tolerance(value, 1e-7))
                  return [new Decimal(Decimal.dNaN), 0];
            ...
            value: function increasingInverse(func) {
              ...
              return function (value) {
                ...
                if (
                  ...
                  return new Decimal(Decimal.dNaN); // Before actually doing the search, let's determine what range we're looking at. First-class function shenanigans incoming.
                ...
                if (currentCheck) {
                  ...
                  if (currentCheck) {
                    ...
                    if (currentCheck)
                      rangeApply = function rangeApply(value) {
                ...
                var comparative = searchIncreasing
                  ? function (a, b) {
                ...
                for (var i = 1; i < iterations; ++i) {
                  ...
                  if (
                    (currently_rose != searchIncreasing &&
                      appliedResult.eq(maxX)) ||
                    (currently_rose == searchIncreasing &&
                      appliedResult.eq(minX))
                  )
                    return new Decimal(Decimal.dNaN);
                  step_size = Math.abs(step_size) * (currently_rose ? -1 : 1);
                  result += step_size;
  ...
  class BrEt {
    getInfo() {
      return {
        ...
        blocks: [
          {
            opcode: "tonumber",
            blockType: "reporter",
            text: Scratch.translate("Convert [N1] to Number"),
            arguments: { N1: { type: "string" } },
          },
          {
            opcode: "fromcomp",
            blockType: "reporter",
            text: Scratch.translate(
              "create a number with sign:[N1]  layer:[N2]  magnitude:[N3]"
            ),
            arguments: {
              N1: { type: "number" },
              N2: { type: "number" },
          ...
          },
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "create a number with mantissa:[N1]  exponent:[N2]"
            ),
            arguments: { N1: { type: "number" }, N2: { type: "number" } },
          },
          "---",
          {
            opcode: "_",
            blockType: "label",
            text: Scratch.translate("Comparators"),
          },
          "---",
          {
            opcode: "comp",
            blockType: "reporter",
            text: Scratch.translate("compare [N1] and [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "compabs",
            blockType: "reporter",
            text: Scratch.translate("abs compare [N1] and [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "isnan",
            blockType: "Boolean",
            text: Scratch.translate("is [N1] NaN"),
            arguments: { N1: { type: "string" } },
          },
          {
            opcode: "isfinite",
            blockType: "Boolean",
            text: Scratch.translate("is [N1] finite"),
            arguments: { N1: { type: "string" } },
          },
          {
            opcode: "eq",
          ...
          },
          {
            opcode: "_",
            blockType: "label",
            text: Scratch.translate("Tolerance Comparators"),
          },
          "---",
          {
            opcode: "tcomp",
            blockType: "reporter",
            text: Scratch.translate(
              "compare [N1] and [N2] with [N3] of tolerance"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
          ...
          },
          {
            opcode: "teq",
            blockType: "Boolean",
            text: Scratch.translate("[N1] = [N2] with [N3] of tolerance"),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
              N3: { type: "string" },
          ...
          "---",
          {
            opcode: "_",
            blockType: "label",
            text: Scratch.translate("Basic Operators"),
          },
          "---",
          {
            opcode: "smthof",
            blockType: "reporter",
            text: Scratch.translate("[N1] of [N2]"),
            arguments: {
              N1: { type: "string", menu: "smthofMenu" },
              N2: { type: "string" },
            },
          },
          {
          ...
          },
          {
            opcode: "log",
            blockType: "reporter",
            text: Scratch.translate("log of [N1] with base [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          "---",
          {
            opcode: "_",
            blockType: "label",
            text: Scratch.translate("Super Operators"),
          },
          "---",
          {
            opcode: "tetrate",
          ...
          },
          {
            opcode: "itexp",
            blockType: "reporter",
            text: Scratch.translate("ln of [N1], [N2] times"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "itlog",
            blockType: "reporter",
            text: Scratch.translate("log of [N1] base [N2], [N3] times"),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
              N3: { type: "string" },
          ...
          },
          {
            opcode: "slog",
            blockType: "reporter",
            text: Scratch.translate("superlog of [N1] base [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "plog",
            blockType: "reporter",
            text: Scratch.translate("pentalog of [N1] base [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "sroot",
            blockType: "reporter",
            text: Scratch.translate("linear super root of [N1] base [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "proot",
            blockType: "reporter",
            text: Scratch.translate("linear penta root of [N1] base [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "ssqrt",
            blockType: "reporter",
            text: Scratch.translate("linear super square root of [N1]"),
            arguments: { N1: { type: "string" } },
          },
          {
            opcode: "tetrate_2",
          ...
          },
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "ln of [N1], [N2] times  |  payload:[N3],  linearly?:[N4]"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
          ...
          },
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "log of [N1] base [N2], [N3] times  |  linearly?:[N4]"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
          ...
          },
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "superlog of [N1] base [N2]  |  iterations:[N3],  linearly?:[N4]"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
          ...
          },
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "pentalog of [N1] base [N2]  |  iterations:[N3],  linearly?:[N4]"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
          ...
          "---",
          {
            opcode: "_",
            blockType: "label",
            text: Scratch.translate("Number Limiters"),
          },
          "---",
          {
            opcode: "max",
            blockType: "reporter",
            text: Scratch.translate("max between [N1] and [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "min",
            blockType: "reporter",
            text: Scratch.translate("min between [N1] and [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "maxabs",
            blockType: "reporter",
            text: Scratch.translate("abs max between [N1] and [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "minabs",
            blockType: "reporter",
            text: Scratch.translate("abs min between [N1] and [N2]"),
            arguments: { N1: { type: "string" }, N2: { type: "string" } },
          },
          {
            opcode: "clamp",
            blockType: "reporter",
            text: Scratch.translate("clamp [N1] between [N2] and [N3]"),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
              N3: { type: "string" },
          ...
          "---",
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "amount obtainble with [N1] resource, where price starts at [N2] exponentially scaled by [N3] while already owning [N4]"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
          ...
          },
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "resources needed to obtain [N1] thing, where price starts at [N2] exponentially scaled by [N3] while already owning [N4]"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
          ...
          },
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "amount obtainble with [N1] resource, where price starts at [N2] linearly scaled by [N3] while already owning [N4]"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
          ...
          },
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "resources needed to obtain [N1] thing, where price starts at [N2] linearly scaled by [N3] while already owning [N4]"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
          ...
          },
          {
            ...
            blockType: "reporter",
            text: Scratch.translate(
              "efficiency of a purchase costing [N1] resources, which increases your resource/sec by [N2], from [N3]"
            ),
            arguments: {
              N1: { type: "string" },
              N2: { type: "string" },
        ...
        menus: {
          ...
          numbers: {
            acceptReporters: true,
            items: ["one", "two", "zero", "negOne", "ten", "nan", "inf"],
          },
        },
      };
    }
    ...
    tonumber({ N1 }) {
      return new Decimal(N1).toNumber();
    }
    fromcomp({ N1, N2, N3 }) {
      return new Decimal().fromComponents(N1, N2, N3).toString();
    }
    fromme({ N1, N2 }) {
      return new Decimal().fromMantissaExponent(N1, N2).toString();
    }
    comp({ N1, N2 }) {
      return new Decimal(N1).cmp(N2);
    }
    compabs({ N1, N2 }) {
      return new Decimal(N1).cmpabs(N2);
    }

    isnan({ N1 }) {
      return new Decimal(N1).isNan();
    }
    isfinite({ N1 }) {
      return new Decimal(N1).isFinite();
    }

    eq({ N1, N2 }) {
      return new Decimal(N1).eq(N2);
    }
    neq({ N1, N2 }) {
      return new Decimal(N1).neq(N2);
    }
    lt({ N1, N2 }) {
      return new Decimal(N1).lt(N2);
    }
    lteq({ N1, N2 }) {
      return new Decimal(N1).lte(N2);
    }
    ht({ N1, N2 }) {
      return new Decimal(N1).gt(N2);
    }
    hteq({ N1, N2 }) {
      return new Decimal(N1).gte(N2);
    }

    tcomp({ N1, N2, N3 }) {
      return new Decimal(N1).cmp_tolerance(N2, N3);
    }
    teq({ N1, N2, N3 }) {
      return new Decimal(N1).eq_tolerance(N2, N3);
    }
    tneq({ N1, N2, N3 }) {
      return new Decimal(N1).neq_tolerance(N2, N3);
    }
    tlt({ N1, N2, N3 }) {
      return new Decimal(N1).lt_tolerance(N2, N3);
    }
    tlteq({ N1, N2, N3 }) {
      return new Decimal(N1).lte_tolerance(N2, N3);
    }
    tht({ N1, N2, N3 }) {
      return new Decimal(N1).gt_tolerance(N2, N3);
    }
    thteq({ N1, N2, N3 }) {
      return new Decimal(N1).gte_tolerance(N2, N3);
    }

    smthof({ N1, N2 }) {
      let x = new Decimal(N2);
      if (N1 == "abs") {
        return x.abs().toString();
      } else if (N1 == "neg") {
        return x.neg().toString();
      } else if (N1 == "round") {
      ...
      } else if (N1 == "truncated") {
        return x.trunc().toString();
      } else if (N1 == "reciprocal") {
        return x.recip().toString();
      } else if (N1 == "factorial") {
        return x.factorial().toString();
      } else if (N1 == "gamma") {
        return x.gamma().toString();
      } else if (N1 == "positive log10") {
        return x.pLog10().toString();
      } else if (N1 == "abs log10") {
        return x.absLog10().toString();
      } else if (N1 == "log10") {
        return x.log10().toString();
      } else if (N1 == "log2") {
        return x.log2().toString();
      } else if (N1 == "natural log") {
        return x.ln().toString();
      } else if (N1 == "pow10") {
        return x.pow10().toString();
      } else if (N1 == "square") {
        return x.sqr().toString();
      } else if (N1 == "cube") {
        return x.pow(3).toString();
      } else if (N1 == "exp") {
        return x.exp().toString();
      } else if (N1 == "sqrt") {
        return x.sqrt().toString();
      } else if (N1 == "cbrt") {
        return x.cbrt().toString();
      } else if (N1 == "sin") {
        return x.sin().toString();
      } else if (N1 == "cos") {
        return x.cos().toString();
      } else if (N1 == "tan") {
        return x.tan().toString();
      } else if (N1 == "asin") {
        return x.asin().toString();
      } else if (N1 == "acos") {
        return x.acos().toString();
      } else if (N1 == "atan") {
        return x.atan().toString();
      } else if (N1 == "sinh") {
        return x.sinh().toString();
      } else if (N1 == "cosh") {
        return x.cosh().toString();
      } else if (N1 == "tanh") {
        return x.tanh().toString();
      } else if (N1 == "asinh") {
        return x.asinh().toString();
      } else if (N1 == "acosh") {
        return x.acosh().toString();
      } else if (N1 == "atanh") {
        return x.atanh().toString();
      } else return x;
    }
    add({ N1, N2 }) {
      return new Decimal(N1).add(N2).toString();
    }
    sub({ N1, N2 }) {
      return new Decimal(N1).sub(N2).toString();
    }
    div({ N1, N2 }) {
      return new Decimal(N1).div(N2).toString();
    }
    mul({ N1, N2 }) {
      return new Decimal(N1).mul(N2).toString();
    }
    mod({ N1, N2 }) {
      return new Decimal(N1).mod(N2).toString();
    }
    log({ N1, N2 }) {
      return new Decimal(N1).log(N2).toString();
    }
    pow({ N1, N2 }) {
      return new Decimal(N1).pow(N2).toString();
    }
    root({ N1, N2 }) {
      return new Decimal(N1).root(N2).toString();
    }

    max({ N1, N2 }) {
      return new Decimal(N1).max(N2).toString();
    }
    min({ N1, N2 }) {
      return new Decimal(N1).min(N2).toString();
    }
    maxabs({ N1, N2 }) {
      return new Decimal(N1).maxabs(N2).toString();
    }
    minabs({ N1, N2 }) {
      return new Decimal(N1).minabs(N2).toString();
    }
    clamp({ N1, N2, N3 }) {
      return new Decimal(N1).clamp(N2, N3).toString();
    }

    tetrate({ N1, N2 }) {
      return new Decimal(N1).tetrate(N2).toString();
    }
    tetrate_2({ N1, N2, N3, N4 }) {
      return new Decimal(N1).tetrate(N2, N3, N4).toString();
    }
    pentate({ N1, N2 }) {
      return new Decimal(N1).pentate(N2).toString();
    }
    pentate_2({ N1, N2, N3, N4 }) {
      return new Decimal(N1).pentate(N2, N3, N4).toString();
    }
    itexp({ N1, N2 }) {
      return new Decimal(N1).iteratedexp(N2).toString();
    }
    itexp_2({ N1, N2, N3, N4 }) {
      return new Decimal(N1).iteratedexp(N2, N3, N4).toString();
    }
    itlog({ N1, N2, N3 }) {
      return new Decimal(N1).iteratedlog(N2, N3).toString();
    }
    itlog_2({ N1, N2, N3, N4 }) {
      return new Decimal(N1).iteratedlog(N2, N3, N4).toString();
    }
    slog({ N1, N2 }) {
      return new Decimal(N1).slog(N2).toString();
    }
    slog_2({ N1, N2, N3, N4 }) {
      return new Decimal(N1).slog(N2, N3, N4).toString();
    }
    plog({ N1, N2 }) {
      return new Decimal(N1).penta_log(N2).toString();
    }
    plog_2({ N1, N2, N3, N4 }) {
      return new Decimal(N1).penta_log(N2, N3, N4).toString();
    }

    sroot({ N1, N2 }) {
      return new Decimal(N1).linear_sroot(N2).toString();
    }
    proot({ N1, N2 }) {
      return new Decimal(N1).linear_penta_root(N2).toString();
    }
    ssqrt({ N1 }) {
      return new Decimal(N1).ssqrt().toString();
    }

    buygeom({ N1, N2, N3, N4 }) {
      let D1 = new Decimal(N1);
      let D2 = new Decimal(N2);
      let D3 = new Decimal(N3);
      let D4 = new Decimal(N4);
      let v = D2.mul(D3.pow(D4));
      return Decimal.floor(
        D1.div(v).mul(D3.sub(1)).add(1).log10().div(D3.log10())
      ).toString();
    }
    ...
    sumgeom({ N1, N2, N3, N4 }) {
      ...
      let D3 = new Decimal(N3);
      let D4 = new Decimal(N4);
      return D2.mul(D3.pow(D4))
        .mul(Decimal.sub(1, D3.pow(D1)))
        .div(Decimal.sub(1, D3))
        .toString();
    }
    ...
    buylin({ N1, N2, N3, N4 }) {
      ...
      let D3 = new Decimal(N3);
      let D4 = new Decimal(N4);
      let a = D2.add(D4.mul(D3));
      let b = a.sub(D3.div(2));
      let b2 = b.pow(2);
      return b
        .neg()
        .add(b2.add(D3.mul(D1).mul(2)).sqrt())
        .div(D3)
        .floor()
        .toString();
    }
    ...
    sumlin({ N1, N2, N3, N4 }) {
      ...
      let a = D2.add(D4.mul(D3));
      return D1.div(2)
        .mul(a.mul(2).plus(D1.sub(1).mul(D3)))
        .toString();
    }
    ...
    buyeff({ N1, N2, N3 }) {
      ...
      let D2 = new Decimal(N2);
      let D3 = new Decimal(N3);
      return D1.div(D2).add(D1.div(D3)).toString();
    }
  }
