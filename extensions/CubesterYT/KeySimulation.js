...
(function (Scratch) {
  ...
  if (window.ResizeObserver) {
    let canvasWidth =
      Scratch.vm.runtime.renderer._xRight - Scratch.vm.runtime.renderer._xLeft;
    let canvasHeight =
      Scratch.vm.runtime.renderer._yTop - Scratch.vm.runtime.renderer._yBottom;
  ...
  const postMouseData = (data) => {
    const [rectangleWidth, rectangleHeight] = canvasSize();
    Scratch.vm.postIOData("mouse", {
      ...
      x:
        (simulatedX +
          (Scratch.vm.runtime.renderer._xRight -
            Scratch.vm.runtime.renderer._xLeft) /
            2) *
        (rectangleWidth /
          (Scratch.vm.runtime.renderer._xRight -
            Scratch.vm.runtime.renderer._xLeft)),
      y:
        ((Scratch.vm.runtime.renderer._yTop -
          Scratch.vm.runtime.renderer._yBottom) /
          2 -
          simulatedY) *
        (rectangleHeight /
          (Scratch.vm.runtime.renderer._yTop -
      ...
      return {
        ...
        menus: {
          KEYS: {
            ...
            items: [
              { text: "space", value: " " },
              { text: "up arrow", value: "ArrowUp" },
              { text: "down arrow", value: "ArrowDown" },
              { text: "right arrow", value: "ArrowRight" },
              { text: "left arrow", value: "ArrowLeft" },
