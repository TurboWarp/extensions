(function(Scratch) {
    ...
    if (EFFECT == 'Invert'){
    return invert;}else {
    if (EFFECT == 'Render mode'){return rendermode;}else {return ''}}}}}}}}
    setrendermode({EFFECT}){
    rendermode = EFFECT;
    setcss();}
    seteffect({EFFECT, NUMBER}) {
    if (EFFECT == 'Blur'){
    blur = NUMBER;}else{if (EFFECT == 'Contrast'){
    contrast = NUMBER;}else{
    if (EFFECT == 'Saturation'){
    saturation = NUMBER;}else{
    if (EFFECT == 'Color'){
    color = NUMBER;}else{
