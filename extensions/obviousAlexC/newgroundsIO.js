    ...
    */
    ...
    class NewgroundsAPI {
        ...
        getScore({rank,scoreBoardID,timeSpan,scoreDataType}){
            ...
            return new Promise((resolve, reject) => { NGIO.getScores(scoreBoardID, searchOptions, (board, scores) => { // <= declaring the board before scores so that we can retrieve the scores.
