// Name: Tools+ Math
// ID: twtoolsplusmath
// Description: Math and geometry utilities for TurboWarp.
// By: fachu2012
// License: MPL-2.0
...
//
// twtoolsplus-math.js — only Tools+ Math.
// Standalone pack: only Tools+ Math (twtoolsplusmath).
//
    ...
    [
      ...
      },
      {
        ...
        arguments: {
          ...
          FORMAT: {
            type: Scratch.ArgumentType.STRING,
            menu: "numberFormatMenu",
            defaultValue: "Roman numeral",
          },
        },
      },
      {
      ...
      },
      {
        ...
        text: Scratch.translate(
          "smooth damp [CURRENT] toward [TARGET] (speed [SPEED])"
        ),
        arguments: {
      ...
      label("Geometry"),
      {
        ...
        blockType: Scratch.BlockType.BOOLEAN,
        text: Scratch.translate(
          "point ([X],[Y]) inside rectangle ([X1],[Y1]) - ([X2],[Y2])?"
        ),
        arguments: {
      ...
      },
      {
        ...
        blockType: Scratch.BlockType.BOOLEAN,
        text: Scratch.translate(
          "point ([X],[Y]) inside circle center ([CX],[CY]) radius [R]?"
        ),
        arguments: {
      ...
      },
      {
        ...
        blockType: Scratch.BlockType.BOOLEAN,
        text: Scratch.translate(
          "do rectangle A ([AX1],[AY1])-([AX2],[AY2]) and rectangle B ([BX1],[BY1])-([BX2],[BY2]) overlap?"
        ),
        arguments: {
      ...
      },
      {
        ...
        blockType: Scratch.BlockType.REPORTER,
        text: Scratch.translate(
          "rotate point ([X],[Y]) around ([CX],[CY]) by [ANGLE] degrees ([AXIS])"
        ),
        arguments: {
          X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 1 },
      ...
      },
      {
        ...
        blockType: Scratch.BlockType.REPORTER,
        text: Scratch.translate(
          "midpoint [AXIS] between ([X1],[Y1]) and ([X2],[Y2])"
        ),
        arguments: {
          AXIS: {
            type: Scratch.ArgumentType.STRING,
