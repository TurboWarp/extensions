// Name: Tools+ Extra
// ID: twtoolsplusextra
// Description: Color, audio, network, and miscellaneous utilities for TurboWarp.
// By: fachu2012
// License: MPL-2.0
...
//
// twtoolsplus-extra.js — only Tools+ Extra.
// Standalone pack: only Tools+ Extra (twtoolsplusextra).
//
  ...
  registerGroup(
    ...
    [
      ...
      },
      {
        ...
        arguments: {
          TEXT: { type: Scratch.ArgumentType.STRING, defaultValue: "a=1&b=2" },
        },
      },
      {
        ...
        arguments: {
          ...
          URL: {
            type: Scratch.ArgumentType.STRING,
            defaultValue: "https://example.com?id=5",
          },
        },
      },
      label("Misc"),
