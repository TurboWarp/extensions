// Name: Tools+ Text
// ID: twtoolsplustext
// Description: Text and list utilities for TurboWarp.
// By: fachu2012
// License: MPL-2.0
...
//
// twtoolsplus-text.js — only Tools+ Text.
// Standalone pack: only Tools+ Text (twtoolsplustext).
//
    ...
    [
      ...
      },
      {
        ...
        arguments: {
          TEXT: {
            type: Scratch.ArgumentType.STRING,
            defaultValue: "hello there world",
          },
        },
      },
      {
      ...
      },
      {
        ...
        arguments: {
          N: { type: Scratch.ArgumentType.NUMBER, defaultValue: 1234567 },
        },
      },
      {
        opcode: "textIsNumber",
        ...
        arguments: {
          TEXT: { type: Scratch.ArgumentType.STRING, defaultValue: "42" },
        },
      },
      label("Lists"),
      {
      ...
      },
      {
        ...
        text: Scratch.translate(
          "weighted pick from items [ITEMS] weights [WEIGHTS]"
        ),
        arguments: {
          ITEMS: {
            type: Scratch.ArgumentType.STRING,
