// Name: Tools+ Sprite
// ID: twtoolsplussprite
// Description: Sprite, stage, camera, and input utilities for TurboWarp.
// By: fachu2012
// License: MPL-2.0
...
//
// twtoolsplus-sprite.js — only Tools+ Sprite.
// Standalone pack: only Tools+ Sprite (twtoolsplussprite).
//
    ...
    [
      ...
      },
      {
        ...
        text: Scratch.translate(
          "orbit [AXIS] around ([CX],[CY]) radius [R] angle [ANGLE]"
        ),
        arguments: {
          AXIS: {
            type: Scratch.ArgumentType.STRING,
      ...
      },
      {
        ...
        blockType: Scratch.BlockType.REPORTER,
        text: Scratch.translate(
          "smooth follow [AXIS] toward ([TX],[TY]) factor [F]"
        ),
        arguments: {
          AXIS: {
            type: Scratch.ArgumentType.STRING,
