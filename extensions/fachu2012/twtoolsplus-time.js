// Name: Tools+ Time
// ID: twtoolsplustime
// Description: Time, control flow, and debugging utilities for TurboWarp.
// By: fachu2012
// License: MPL-2.0
...
//
// twtoolsplus-time.js — only Tools+ Time.
// Standalone pack: only Tools+ Time (twtoolsplustime).
//
    ...
    [
      ...
      },
      {
        ...
        text: Scratch.translate(
          "tween [ID] from [A] to [B] in [SECONDS]s ([EASING])"
        ),
        arguments: {
      ...
      },
      {
        ...
        arguments: {
          ID: { type: Scratch.ArgumentType.STRING, defaultValue: "init" },
        },
      },
      label("Control flow"),
      {
      ...
      },
      {
        ...
        blockType: Scratch.BlockType.BOOLEAN,
        text: Scratch.translate(
          "debounce [ID]: has [SECONDS] seconds passed since last call?"
        ),
        arguments: {
      ...
      },
      {
        ...
        blockType: Scratch.BlockType.BOOLEAN,
        text: Scratch.translate(
          "throttle [ID]: allow call every [SECONDS] seconds?"
        ),
        arguments: {
          ID: { type: Scratch.ArgumentType.STRING, defaultValue: "action1" },
          SECONDS: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0.5 },
