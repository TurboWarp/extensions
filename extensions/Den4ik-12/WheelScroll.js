...
(function (Scratch) {
  ...
  const buttonTOSPTexts = [
    "Enable other scroll types",
    "Disable other scroll types",
  ];
  let enabledOtherScrollParameters = false;
  const vm = Scratch.vm;
  ...
  class WheelScroll {
    getInfo() {
      return {
        ...
        blocks: [
          {
            func: "toogleOtherScrollTypes",
            text: buttonTOSPTexts[
              Scratch.Cast.toNumber(enabledOtherScrollParameters)
            ],
        ...
        menus: {
          SCROLL_TYPE: {
            items: "_generateScrollTypesMenu",
          },
          DELTA_TYPE: {
            acceptReporters: true,
            items: "_generateDeltaTypesMenu",
          },
        },
      };
    }
    _generateScrollTypesMenu() {
