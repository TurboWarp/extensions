...
// Extension
  class WheelScroll {
    getInfo() {
      return {
        id: 'Den4ik12WheelScroll',
        name: Scratch.translate({id: 'extName', default: 'Whell Scroll'}),
        color1: '#E74C3C',
        color2: '#CB4335',
        color3: '#B03A2E',
        menuIconURI: ExtIcon,
        ...
        blocks: [
          {
            ...
            text: Scratch.translate({id: 'whenScrollDir', default: 'when mouse whell scrolls [SCROLL_TYPE]'}),
        ...
        menus: {
          SCROLL_TYPE: [
            {
              text: Scratch.translate({id: 'menuSCROLL_TYPEvalueU', default: 'up'}),
              value: 'u'
            },
            {
              text: Scratch.translate({id: 'menuSCROLL_TYPEvalueD', default: 'down'}),
              value: 'd'
            },
            {
              text: Scratch.translate({id: 'menuSCROLL_TYPEvalueL', default: 'to the left'}),
              value: 'l'
            },
            {
              text: Scratch.translate({id: 'menuSCROLL_TYPEvalueR', default: 'to the right'}),
              value: 'r'
            },
            {
              text: Scratch.translate({id: 'menuSCROLL_TYPEvalueO', default: 'out'}),
              value: 'o'
            },
            {
              text: Scratch.translate({id: 'menuSCROLL_TYPEvalueI', default: 'in'}),
              value: 'i'
            },
            {
              text: Scratch.translate({id: 'menuSCROLL_TYPEvalueAX', default: 'along the x-axis'}),
              value: 'ax'
            },
            {
              text: Scratch.translate({id: 'menuSCROLL_TYPEvalueAY', default: 'along the y-axis'}),
              value: 'ay'
            },
            {
              text: Scratch.translate({id: 'menuSCROLL_TYPEvalueAZ', default: 'along the z-axis'}),
              value: 'az'
            }
          ]
        }
