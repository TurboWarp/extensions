...
(function (Scratch) {
  ...
  class HtmlElements {
    ...
    getBlockDefinitions() {
      return [
        ...
        },
        {
          ...
          arguments: {
            ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'dropdown1' },
            X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
            Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
            OPTIONS: { type: Scratch.ArgumentType.STRING, defaultValue: 'option1,option2,option3' },
          },
        },
        {
          opcode: 'createButton',
        ...
        },
        {
          ...
          arguments: {
            ...
            X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
            Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
            TEXT: { type: Scratch.ArgumentType.STRING, defaultValue: 'Toggle me' },
          },
        },
        {
          opcode: 'createPanel',
        ...
        },
        {
          ...
          arguments: {
            ID: { type: Scratch.ArgumentType.STRING, defaultValue: 'button1' },
            ALPHA: { type: Scratch.ArgumentType.NUMBER, defaultValue: 1, min: 0, max: 1 },
          },
        },
        {
    ...
    createElement(tag, { ID, X, Y }, additionalSetup = () => {}) {
      ...
      this.elements[ID] = { element, overlay: element, zIndex: this.zIndexCounter++ };
    ...
    createDropdown({ ID, X, Y, OPTIONS }) {
      this.createElement('select', { ID, X, Y }, (select) => {
        Cast.toString(OPTIONS).split(',').forEach(optionText => {
    ...
    setElementTextTransparency({ ID, ALPHA }) {
      ID = Cast.toString(ID);
      if (this.elements[ID]) {
        const color = this.elements[ID].element.style.color || 'rgba(0, 0, 0, 1)';
    ...
    removeAllElements() {
      Object.keys(this.elements).forEach(id => this.removeElement({ ID: id }));
      this.zIndexCounter = 0;
    }
