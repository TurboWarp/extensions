...
(function (Scratch) {
  ...
  class Js_math {
    ...
    getInfo() {
      const blocks = [
        {
          ...
          text: Scratch.translate("evaluate [EXPRESSION]"),
          arguments: {
            EXPRESSION: {
        ...
        },
        {
          ...
          text: Scratch.translate("is [EXPRESSION] a valid equation?"),
          arguments: {
            EXPRESSION: {
              type: Scratch.ArgumentType.STRING,
              defaultValue: "2 + 3 * 4",
      ...
      return {
        id: "jsmath",
        name: Scratch.translate("JS Math"),
        blocks: blocks,
      };
    }
    ...
    callFunction(name, args) {
      if (name === "random") {
        if (args.length !== 0) {
          throw new Error(
            'Function "random" expects no arguments, got ' + args.length
          );
        }
        return Math.random();
      }
