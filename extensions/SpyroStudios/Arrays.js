      ...
      return {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: "set value in 3D array [NAME] at depth [DEPTH] row [ROW] column [COLUMN] to [VALUE]",
            blockType: BlockType.COMMAND,
            arguments: {
              NAME: {
                type: ArgumentType.STRING,
          ...
          },
          {
            ...
            text: "value in 3D array [NAME] at depth [DEPTH] row [ROW] column [COLUMN]",
            blockType: BlockType.REPORTER,
            arguments: {
              NAME: {
                type: ArgumentType.STRING,
          ...
          },
          {
            ...
            text: "count occurrences of item [ITEM] in 3D array [NAME]",
            blockType: BlockType.REPORTER,
            arguments: {
              ITEM: {
                type: ArgumentType.STRING,
