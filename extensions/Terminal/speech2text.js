...
(function (Scratch) {
  ...
  if (!Scratch.extensions.unsandboxed) {
    throw new Error("Speech to text extension must run unsandboxed");
  }
  class ScratchSPT {
    constructor(runtime) {
      ...
      if (
        ...
        console.error(
          "Your browser does not support the Web Speech API. Firefox is known to not support this extension.",
        );
        return;
      }
      ...
      if (isChromium && !("SpeechRecognition" in window)) {
        console.warn(
          "Running on a Chromium browser, but using webkitSpeechRecognition. This may not work!",
        );
      }
