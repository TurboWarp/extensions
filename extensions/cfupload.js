...
(function (Scratch) {
  ...
  let StatusCode = 0;
  let RawRespond = "";
  let pastebinkey = "zvRcx16j8TYvEDimPAgdYisrSbZqWMPo";
      ...
      return {
        ...
        menus: {
          Apis: {
            ...
            items: ["catbox.moe", "file.io", "0x0.st", "pastebin.com"],
          },
          MimeTypes: {
            acceptReporters: true,
            items: [
          ...
          tf: {
            acceptReporters: true,
            items: ["true", "false"], // idk how to do so menu
          },
        },
      };
    }
    ...
    callapi(args) {
      switch (args.Apis) {
        ...
        case "pastebin.com":
          ...
          urlencoded.append("api_dev_key", pastebinkey);
          urlencoded.append("api_option", "paste");
          urlencoded.append("api_paste_code", fileData);
          ...
          return Scratch.fetch(apiurl, requestOptions)
