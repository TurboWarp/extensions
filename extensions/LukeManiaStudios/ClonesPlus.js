(function(Scratch) {
  ...
  class ClonesPlus {
    ...
    getThingOfClone(args, util) {
      ...
      if (args.INPUTA === 'x position') {
        return clone.x;
      }
      if (args.INPUTA === 'y position') {
        return clone.y;
      }
      if (args.INPUTA === 'direction') {
        return clone.direction;
      }
      if (args.INPUTA === 'costume num') {
        return (clone.currentCostume + 1);
      }
      if (args.INPUTA === 'costume name') {
    ...
    getThingOfMainSprite(args, util) {
      const main = util.target.sprite.clones[0];
      if (args.INPUT === 'x position') {
        return main.x;
      }
      if (args.INPUT === 'y position') {
        return main.y;
      }
      if (args.INPUT === 'direction') {
        return main.direction;
      }
      if (args.INPUT === 'costume num') {
        return (main.currentCostume + 1);
      }
      if (args.INPUT === 'costume name') {
        return main.getCostumes()[main.currentCostume].name;
      }
      if (args.INPUT === 'size') {
        return main.size;
      }
