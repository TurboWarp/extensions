...
(function(Scratch) {
    ...
    console.log(
        'Loaded ElectraGPT v1.7 by MubiLop (https://mubi.tech/) and edited by Aness6040 (https://aness6040.vercel.app)'
    );
    ...
    class ElectraGPT {
            ...
            return {
                ...
                blocks: [
                    {
                        ...
                        text: Scratch.translate('Reverse Proxy API Blocks')
                    },
                    {
                        opcode: 'setApiUrl',
                        blockType: Scratch.BlockType.COMMAND,
                        text: Scratch.translate(
                            'Set reverse proxy API Base URL to [URL]'
                        ),
                        arguments: {
                            URL: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue:
                                    'https://cj2api.keh5.workers.dev/v1'
                            }
                        }
                    },
                    {
                    ...
                    },
                    {
                        ...
                        text: Scratch.translate('Is reverse proxy working?'),
                        disableMonitor: true
                    },
                    {
                        opcode: '__NOUSEOPCODE',
                        blockType: Scratch.BlockType.LABEL,
                        text: Scratch.translate('Prompts')
                    },
                    {
                        opcode: 'getPrompt',
                        blockType: Scratch.BlockType.REPORTER,
                        text: Scratch.translate('Get prompt [TYPE]'),
                        arguments: {
                            TYPE: {
                                type: Scratch.ArgumentType.STRING,
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.REPORTER,
                        text: Scratch.translate(
                            'Generate from text (No Context): [PROMPT]'
                        ),
                        arguments: {
                            PROMPT: {
                                type: Scratch.ArgumentType.STRING,
                    ...
                    },
                    {
                        opcode: 'informChat',
                        blockType: Scratch.BlockType.COMMAND,
                        text: Scratch.translate('Inform [chatID] that [inform]'),
                        arguments: {
                            chatID: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue: 'Foo'
                            ...
                            inform: {
                                type: Scratch.ArgumentType.STRING,
                                defaultValue:
                                    'You can only speak in meows and other cat noises.'
                            }
                        }
                    },
                    {
                        opcode: '__NOUSEOPCODE',
                        blockType: Scratch.BlockType.LABEL,
                        text: Scratch.translate('Chatbot management')
                    },
                    {
                        opcode: 'createChat',
                        blockType: Scratch.BlockType.COMMAND,
                        text: Scratch.translate(
                            'Create chatbot named [chatID]'
                        ),
                        arguments: {
                            chatID: {
                                type: Scratch.ArgumentType.STRING,
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.REPORTER,
                        text: Scratch.translate(
                            'Chat history of [chatID] as Array'
                        ),
                        arguments: {
                            chatID: {
                                type: Scratch.ArgumentType.STRING,
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: Scratch.translate(
                            'Import chat history from [json] as [chatID]'
                        ),
                        arguments: {
                            json: {
                                type: Scratch.ArgumentType.STRING,
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: Scratch.translate(
                            'Import chats from [json] and [merge]'
                        ),
                        arguments: {
                            json: {
                                type: Scratch.ArgumentType.STRING,
                    ...
                    },
                    {
                        opcode: 'exportAll',
                        blockType: Scratch.BlockType.REPORTER,
                        text: Scratch.translate('All chats as Arrays')
                    },
                    {
                        opcode: 'listChats',
                        blockType: Scratch.BlockType.REPORTER,
                        text: Scratch.translate('Currently Active chats')
                    },
                    {
                        opcode: '__NOUSEOPCODE',
                        blockType: Scratch.BlockType.LABEL,
                        text: Scratch.translate('Image Generation')
                    },
                    {
                        opcode: 'generateImage',
                        blockType: Scratch.BlockType.REPORTER,
                        text: Scratch.translate(
                            'Generate [PROMPT] from [MODEL] and get Response'
                        ),
                        arguments: {
                            PROMPT: {
                                type: Scratch.ArgumentType.STRING,
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.REPORTER,
                        text: Scratch.translate(
                            'Generate [PROMPT] from [MODEL] and import as costume with name [NAME]'
                        ),
                        arguments: {
                            PROMPT: {
                                type: Scratch.ArgumentType.STRING,
                ...
                menus: {
                    ...
                    merge: {
                        acceptReporters: true,
                        items: [
                            'Merge/Update existing chats',
                            'Remove all chatbots and import'
                        ]
                    },
                    ...
                    promptTypes: {
                        ...
                        items: [
                            ...
                            },
                            {
                                ...
                                value: `I want you to act as an advertiser. You will create a campaign to promote a product or service of your choice. You will choose a target audience, develop key messages and slogans, select the media channels to use, and decide on any additional activities needed to reach the audience.`
                            },
                            {
        ...
        generateImage(args) {
            ...
            return Scratch.fetch(`${api_url}/images/generations`, {
                ...
                .catch(error => {
                    console.error(
                        'Error sending prompt to Image Generator',
                        error.message
                    );
                    return `Error: ${error.message}`;
                });
        ...
        generateImageAndImport(args, util) {
            ...
            return Scratch.fetch(`${api_url}/images/generations`, {
                ...
                .then(data => {
                    ...
                    return Scratch.fetch(targetUrl);
                })
        ...
        exportChat(args) {
            ...
            if (this.chatHistories[chatID] !== undefined) {
                return JSON.stringify(this.chatHistories[chatID]);
            }
        ...
        listChats() {
            return JSON.stringify(Object.keys(this.chatHistories));
        }
        ...
        importAll(args) {
            ...
            if (
                typeof importedChats === 'object' &&
                importedChats !== null
            ) {
                if (mergeOption === 'remove all and import') {
                    this.chatHistories = importedChats;
                } else if (
                    mergeOption === 'merge with existing chats'
                ) {
                    const importedChatIDs = Object.keys(importedChats);

                    for (const chatID of importedChatIDs) {
                        this.chatHistories[chatID] =
                            importedChats[chatID];
                    }
                } else {
                    console.error(
                        'Invalid merge option. Expected "remove all and import" or "merge with existing chats".'
                    );
