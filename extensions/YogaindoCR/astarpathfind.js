...
(function(Scratch) {
    ...
    class PriorityQueue {
        ...
        bubbleDown(index) {
            ...
            if (rightIndex < this.heap.length && rightIndex < this.heap.length && this.heap[rightIndex].f < this.heap[smallestIndex].f) { //Fixed Bug
        ...
        swap(i, j) {
            ...
            this.map.set(`${this.heap[i].node.x},${this.heap[i].node.y}`, this.heap[i]);
            this.map.set(`${this.heap[j].node.x},${this.heap[j].node.y}`, this.heap[j]);
        }
    ...
    class AStarExtension {
            ...
            try {
                ...
                while (!openSet.isEmpty()) {
                    ...
                    for (const neighbor of neighbors) {
                        ...
                        if (!openSet.has(nextNode) || g < openSet.getG(nextNode) || (g === openSet.getG(nextNode) && this.cross(start2D, nextNode, end2D) < this.cross(start2D, openSet.map.get(`${nextNode.x},${nextNode.y}`).node, end2D))) {
        ...
        jump(grid, current, neighbor, gridSize) {
            ...
            while (true) {
                ...
                if (dx !== 0) {
                    if ((y > 0 && grid[y - 1][x] === 0 && grid[y - 1][x - dx] !== 0) ||
                        (y < gridSize - 1 && grid[y + 1][x] === 0 && grid[y + 1][x - dx] !== 0)) {
                        return {
                            x,
                            y
                        };
                    ...
                    if ((x > 0 && grid[y][x - 1] === 0 && grid[y - dy][x - 1] !== 0) ||
                        (x < gridSize - 1 && grid[y][x + 1] === 0 && grid[y - dy][x + 1] !== 0)) {
                        return {
                            x,
                            y
                        };
